...
def _index():
    ...
    if request.method == "GET":
        ...
        return render_template("index.html", participated_projects=current_user.collaborated_projects, projects=projects, image_file=image_file, pageTitle=pageTitle)
